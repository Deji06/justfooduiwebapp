    ...
    <>
      <section className=" sm:w-[1280px] my-5 mx-auto pb-10">
        ...
        <div className="flex justify-between mt-5">
          ...
          <div className="bg-[#E7FAFE] w-[300px] rounded-[10px] px-3 py-3">
      ...
      <section className="sm:w-[1280px] flex flex-col gap-y-3 my-5 mx-auto pb-10">
        ...
        <p className="mx-6 my-2 text-[#8392A7] w-[700px]">
        ...
        <Image src={womanChef} className="w-[650px] ml-5" />
        <p className="mx-6 my-2 text-[#8392A7] w-[700px]">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia c
        ...
        <div className="border w-[700px] mx-6"></div>
        <div className="flex items-center gap-x-3 ">
          <input type="checkbox" />
          <p className="font-semibold text-[18px]">
      ...
      <section className="px-3 sm:w-[1280px] mx-auto py-12 pb-10 rounded-[40px] bg-[#E7F9FD] relative">
        ...
        <section className="sm:w-[1280px] my-10 mx-auto pb-10 ">
          <p className="text-center font-semibold text-[30px]">You may like these recipe too</p>
