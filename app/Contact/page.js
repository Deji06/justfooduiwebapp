  ...
  return (
    <section className="px-3 sm:w-[1280px] mx-auto py-12 pb-10">
      ...
      <div className="flex gap-x-16  mt-10">
        <Image src={chef} className="recipebg rounded-[10px] ml-5" />
        <div className="flex flex-col gap-y-5 w-[80%]">
          <form className=" grid grid-cols-2 py-2 h-[250px]">
            <div className="flex flex-col gap-y-2">
              ...
              <input
                ...
                className="border-2 py-3 px-4 rounded-[10px] w-[80%]"
              />
            </div>
            <div className="flex flex-col gap-y-2">
              <label
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <select
                name=""
                id=""
                className="border-2 py-3 px-4 rounded-[10px] w-[80%] outline-none"
              >
          ...
          <div className='flex flex-col gap-y-3'>
            ...
            <textarea placeholder='Enter your message' className='border-2 w-[80%] h-[100px] rounded-[10px] outline-none p-3'></textarea>
          </div>
          {/*  */}
          <button
            type="submit"
